...
def try_methods():
    yeet = rg.SimpleTurtle()
    yeet.pen = rg.Pen('brown', 5)
    yeet.forward(150)
    yeet.left(90)
    yeet.forward(50)
    yeet.backward(100)
...
def try_methods_and_functions():
    boi = rg.SimpleTurtle()
    boi.pen = rg.Pen('blue',len("what?"))
    boi.backward(150)
    boi.speed = 1
    draw_many_squares(boi,2,100,30)
    boi.speed = 5
    boi.pen = rg.Pen('red',len('water'))
    draw_many_squares(boi,10,50,15)
    boi.speed = 100
    boi.pen = rg.Pen('red',len('hello there space cadet, roommates'))
    draw_many_squares(boi,8,300,60)
    boi.pen = rg.Pen('black',len('ugh'))
    boi.backward(200)
    boi.draw_circle(30)
    boi.draw_square(50)
