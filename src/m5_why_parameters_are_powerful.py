...
def main():
    ...
    #better_draw_circles(rg.Point(-200, 0),12)
    #even_better_draw_circles(rg.Point(100,50),20,5,'magenta',5)
    #even_better_draw_circles(rg.Point(-200,0),12,20,'cyan',10)
    even_better_draw_circles(rg.Point(0, 200), 10, 10, 'red', 1)
    even_better_draw_circles(rg.Point(173.205, 100), 10, 10, 'orange', 2)
    even_better_draw_circles(rg.Point(173.205, -100), 10, 10, 'yellow', 3)
    even_better_draw_circles(rg.Point(0, -200), 10, 10, 'green', 4)
    even_better_draw_circles(rg.Point(-173.205, -100), 10, 10, 'blue', 5)
    even_better_draw_circles(rg.Point(-173.205, 100), 10, 10, 'purple', 6)
